...
const THEMES: BranchTheme[] = [
  { accent: '#8b3cf7', iconBg: '#E3EFFB', glow: 'rgba(227,239,251,0.85)' }, // EG Digital — violet
  { accent: '#c07a0a', iconBg: '#E3EFFB', glow: 'rgba(227,239,251,0.85)' }, // EG Foundations — amber
  { accent: '#1d6ef5', iconBg: '#E3EFFB', glow: 'rgba(227,239,251,0.85)' }, // EG Imports — blue
  { accent: '#ea6f13', iconBg: '#E3EFFB', glow: 'rgba(227,239,251,0.85)' }, // EG Transport — orange
  { accent: '#0d9a6a', iconBg: '#E3EFFB', glow: 'rgba(227,239,251,0.85)' }, // EG Travels — emerald
];
      ...
      <div className="grid gap-6 pl-12 sm:pl-14 md:grid-cols-2 md:items-center md:gap-0 md:pl-0">
        ...
        >
          ...
          <motion.div style={{ y: orbY }} className="will-transform relative">
            ...
            />
            <span
              style={{ backgroundColor: theme.iconBg, color: '#114781' }}
        ...
        >
          <span style={{ color: '#0B2B4F' }} className="text-eyebrow-fluid font-normal uppercase">
...
/* ── Section: duplicate of "Our Companies" for iteration ─────────────── */
export function CompaniesCopy() {
