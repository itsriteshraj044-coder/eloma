...
/**
 * Duplicate of "Capabilities Schematic" for iteration.
...
export function CapabilitiesSchematicCopy() {
  const [hovered, setHovered] = useState<number | null>(null);

  return (
    <section
      id="capabilities-schematic-copy"
      aria-label="Global capabilities — schematic duplicate"
      ...
      <Container className="relative">
        ...
        <div className="relative mx-auto mt-10 hidden aspect-[2/1] w-full max-w-5xl lg:block">
          ...
          <svg aria-hidden="true" viewBox="0 0 800 420" className="absolute inset-0 h-full w-full">
            ...
            />
            {/* White disc — clears the wireframe lines directly behind the hub logo */}
            <circle cx="400" cy="210" r="48" fill="#ffffff" />
          ...
          <img
            ...
            height={96}
            decoding="async"
            className="pointer-events-none absolute left-1/2 top-1/2 h-[clamp(3.5rem,7vw,6rem)] w-auto -translate-x-1/2 -translate-y-1/2 object-contain mix-blend-multiply"
          />
