...
/**
 * "The Group Line".
 * The six divisions as stations on a single metro line departing from the
 * Eloma depot. The line draws itself in on scroll and a small emerald
 * "train" rides it on loop (frame-driven along the path geometry). The
 * train conducts the content: whichever station it last reached is the one
 * whose dossier is open under the map, and clicking a station calls the
 * train straight there. Reduced motion parks the train; stations are then
 * click-only. Below lg the line turns vertical: a route timeline with every
 * division's details inline.
 */
...
export function BusinessTransit() {
  ...
  // Drive the train along the line; arriving at a station opens its dossier.
  ...
  return (
    <section
      ref={sectionRef}
      id="business-transit"
      aria-label="Our businesses — the group line"
      ...
      <Container className="relative">
              ...
              return (
                ...
                >
                  <button
                    ...
                    aria-label={`${business.index}: ${business.title}`}
                    className={cn(
                  ...
                  >
                    ...
                    >
                      <span className="mr-1.5 font-bold text-emerald-600">{business.index}</span>
                      {business.title}
                    </span>
                  </button>
                </div>
                  ...
                  <div className="flex items-center gap-4 sm:col-span-4">
                    ...
                    <div>
                      <p className="text-[11px] font-bold uppercase tracking-[2px] text-navy-400">
                        {active.index} / 0{BUSINESSES.length}
                      </p>
        ...
        >
          ...
          {BUSINESSES.map((business) => {
            ...
            return (
              <motion.li key={business.id} variants={fadeUp} className="relative pb-8 pl-12 last:pb-0">
                {/* Station dot */}
                <span
                  aria-hidden="true"
                ...
                />
                <p className="text-[11px] font-bold uppercase tracking-[2px] text-navy-400">
                  {business.index} / 0{BUSINESSES.length}
                </p>
